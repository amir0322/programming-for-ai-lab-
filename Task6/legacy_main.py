...
# external libraries used by legacy version
from ultralytics import YOLO
import easyocr

# configuration constants used in legacy code
MODEL_FILE = "best.pt"
FONT_FOLDER = "fonts"
...
# reuse shared library modules (packed under parking_engine)
...
app_logger = logging.getLogger("parking_ui")
